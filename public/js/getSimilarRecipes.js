let response = {
    ...
    "_links": {
        "next": {
            "href": "https://api.edamam.com/api/recipes/v2?q=chicken&app_key=7028497c6eb06f6a79cd95e13e36a591&_cont=CHcVQBtNNQphDmgVQntAEX4BYldtBAEGS2RFBGoTZVZ6AgcOUXlSB2AXZVJzUgIAEWFGBDcbZFclUQoBSm1FBmUVZ1MhAgAVLnlSVSBMPkd5BgMbUSYRVTdgMgksRlpSAAcRXTVGcV84SU4%3D&type=public&app_id=6bf21e81",
            "title": "Next page"
        }
    },
    "hits": [
        {
            ...
            "_links": {
                "self": {
                    "href": "https://api.edamam.com/api/recipes/v2/b79327d05b8e5b838ad6cfd9576b30b6?type=public&app_id=6bf21e81&app_key=7028497c6eb06f6a79cd95e13e36a591",
                    "title": "Self"
                }
            }
        },
        {
            ...
            "_links": {
                "self": {
                    "href": "https://api.edamam.com/api/recipes/v2/8275bb28647abcedef0baaf2dcf34f8b?type=public&app_id=6bf21e81&app_key=7028497c6eb06f6a79cd95e13e36a591",
                    "title": "Self"
                }
            }
        },
        {
            ...
            "_links": {
                "self": {
                    "href": "https://api.edamam.com/api/recipes/v2/be3ba087e212f13672b553ecfa876333?type=public&app_id=6bf21e81&app_key=7028497c6eb06f6a79cd95e13e36a591",
                    "title": "Self"
                }
            }
        }
...
$('#btnQueryConfirm').click(function(e) {
    ...
    xhttp.onreadystatechange = () => {
        ...
        if (xhttp.readyState == 4 && xhttp.status == 200) {
            ...
            getSimilarRecipes(xhttp.response)
...
$('#similarRecipeLink').click(function(e) {
    e.preventDefault();
    let url = $('#similarRecipeLink').prop('name')
    console.log("*******", url)
})



function getSimilarRecipes(response) {
    ...
    hits.forEach(function (element, index) {
        ...
        let source = element.recipe.source
        ...
        btn.attr('class', 'btnSimilarRecipe')
        btn.text(label)
        ...
        var row = $("<tr>") 
        var td1 = $("<td>").append(form)
        var td2 = $("<td>").text(source) 
        row.append(td1)
        row.append(td2)
